...
class NetworkFramework(object):
  ...
  def Train(self, images, validation_images, test_images, learning_rate, epochs):
    ...
    test_log = []
    test_log.append(self.Performance(test_images))
    ...
    for i in range(epochs):
      ...
      # print self.network.complete
      # #print self.network.inputs.values
      # #print self.hidden_nodes = []
      # #print self.outputs = []
      # #print self.node_set 
      if i>=5:
        weights = [weight.value for weight in self.network.weights] 
        print weights
      #for weight in self.network.weights:
      #   print weight.value
